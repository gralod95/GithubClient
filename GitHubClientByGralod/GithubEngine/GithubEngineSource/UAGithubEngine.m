...
#pragma mark Commits
- (void)commitsForRepository:(NSString *)repositoryPath
                atListNumber:(NSInteger)aListNumber
                     ...
                     failure:(UAGithubEngineFailureBlock)failureBlock
{
    ...
    [self invoke:^(id self)
    {
        [self sendRequest:requestString
              requestType:UAGithubCommitsRequest
             responseType:UAGithubCommitsResponse
                    error:nil];
